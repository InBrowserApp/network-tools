...
/**
 * Fetches the public IPv4 address of the client using ip.sb.
 *
...
/**
 * Fetches the public IPv6 address of the client using ip.sb.
 *
 * @param options - Optional fetch options.
...
/**
 * An object containing methods to fetch the public IPv4 and IPv6 addresses using ip.sb.
 * @public
 */
